    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            String upperString = StringToUpper("hello");
            Console.WriteLine(upperString);

            String lowerCaseString = StringToLower("HELLO");
            Console.WriteLine(lowerCaseString);

            String stringWithWhiteSpace = StringTrim("   a string with whitespace   ");
            Console.WriteLine(stringWithWhiteSpace);

            String subString = StringSubstring("Hello World", 0, 3);
            Console.WriteLine(subString);

            String searchString = SearchChar("Hello World", 'd').ToString();
